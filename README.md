...
### Modes
_Portion of Screen_ supports two modes, selected via **System Menu** > **Options** (the system menu opens by clicking the icon in the title bar or with Alt+Space):
...
- **System Menu** > **Size** locks the shared area to 1280 x 720, 1600 x 900, 1920 x 1080, 1920 x 1200, 2560 x 1440 or a custom size. Sizes are physical pixels, also on scaled (125 %, 150 %) displays and mixed multi-monitor setups.
...
- The title bar is transmitted as part of the window. Once sharing runs, choose **System Menu** > **Hide title bar** so that the shared window is exactly the chosen size. The title bar comes back whenever the window is activated (taskbar, Alt+Tab). Hide it only after you selected the window in Teams; windows without a title bar are not listed in the share picker.
